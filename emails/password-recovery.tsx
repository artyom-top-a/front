...
export const PasswordRecoveryEmail = ({
  ...
  const previewText = `Recover your password for [SaaS]`;
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          ...
          <Img
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              We received a request to reset your password for your <strong>GStudy</strong> account. Click the button below to reset your password.
            </Text>

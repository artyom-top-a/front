...
const GenerateDeckDialog = () => {
  ...
  const handleGenerate = async () => {
    ...
    setLoading(true);
    const route = `/api/flashcards/${selectedType}`;
    ...
    try {
      ...
      alert("An error occurred while generating the deck.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Dialog open={showGenerateModal} onOpenChange={setShowGenerateModal}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Generate Deck</DialogTitle>
            <DialogDescription>
              Select the type of content and provide necessary details to start generating a deck.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button
              ...
              disabled={loading}
              className="w-full h-12 font-bold bg-[#6127FF] text-white"
            >
              <Loader loading={loading}>Generate Deck</Loader>
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
...
export default GenerateDeckDialog;
